...
public class AccumulationProfitBean {
    //biz_dt String 业务日期
    @JsonProperty("date")
    ...
    private BigDecimal day_profit;
    //post_profit DECIMAL(26,4) 持仓收益
    @JsonProperty("post_profit")
    private BigDecimal post_profit;
    @JsonIgnore
    ...
    @JsonIgnore
    public BigDecimal getDay_profit() {
        return day_profit;
    }
    @JsonIgnore
    public void setDay_profit(BigDecimal day_profit) {
        this.day_profit = day_profit;
    }
    @JsonIgnore
    public BigDecimal getPost_profit() {
        return post_profit;
    }
    @JsonIgnore
    public void setPost_profit(BigDecimal post_profit) {
