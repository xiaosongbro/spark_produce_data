...
public class FundSubscription {
    ...
    @JsonProperty("fundPurchDt")
    private String fundPurchDt;
    ...
    public String getFundPurchDt() {
        return fundPurchDt;
    }

    public void setFundPurchDt(String fundPurchDt) {
        this.fundPurchDt = fundPurchDt;
    }
