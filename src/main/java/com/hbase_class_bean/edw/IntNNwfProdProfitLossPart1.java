...
public class IntNNwfProdProfitLossPart1 {
    //Biz_Month	月份	DATE
    ...
    private ArrayList<IntNNwfProdProfitLossPart2> productList;
    ...
    @JsonIgnore
    public ArrayList<IntNNwfProdProfitLossPart2> getProductList() {
        return productList;
    }
    @JsonIgnore
    public void setProductList(ArrayList<IntNNwfProdProfitLossPart2> productList) {
